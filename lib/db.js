...
const isListingFavourited = function(userID, listingID) {
  if (pool.query(`SELECT EXISTS (SELECT 1 FROM favourites WHERE user_id = $1 AND listing_id = $2)`, [userID, listingID])) {
    return true;
  }
  return false;
};
...
const searchForListing = function() {
=======

>>>>>>> 4e9105cc23aeb06814104d0fee4b7d4daef43d52
